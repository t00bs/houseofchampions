  ...
  return (
    <section className="membership reveal" id="membership">
      ...
      <div className="membership-head">
        ...
        <h2 className="h-section">Four ways <em>in.</em></h2>
        <p style={{color:"var(--ink-dim)", maxWidth:"640px", fontSize:"15px", lineHeight:"1.65"}}>
          Start with Atelier and step further inside as you go. Early-bird pricing is in place for our founding cohort — lock yours in before the doors fully open.
        </p>
      </div>
      )}
              ...
              <div className="tier-body">
                ...
                {t.earlyPrice && (
                  <div className="early-bird">
                    ...
                    <span className="eb-price">{t.earlyPrice}<span className="per">{t.per}</span></span>
                  </div>
                )}
