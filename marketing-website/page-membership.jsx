  ...
  return (
    <>
      ...
      <PageHero
        index="Nº 005"
        kicker="Membership"
        title={<>Four ways <em>in.</em></>}
        lead="Start with Atelier and step further inside as you go. Early-bird pricing is held for our founding cohort — locked for the life of your membership, not just the first year."
        meta={[["Tiers", "Four · one invite-only"], ["From", "£200 / mo early bird"], ["Term", "Monthly rolling"], ["Cohort", "Founding · Spring 2026"]]}
        actions={<>
