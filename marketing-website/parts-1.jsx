    ...
    <section className="hero" id="top">
      ...
      <div className="hero-meta">
        ...
        <div className="hero-stats">
          ...
          <div className="stat"><span className="num">04</span><span className="label">Memberships</span></div>
          <div className="stat"><span className="num">7</span><span className="label">Days · Dawn–Late</span></div>
        </div>
      </div>
