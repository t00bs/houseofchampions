        ...
        <div className="wf-row" style={{ gap: 18, alignItems: 'stretch' }}>
          ...
          <div className="wf-card" style={{ flex: 1, padding: 18 }}>
            ...
            <div style={{ marginTop: 6 }}>
              ...
              <DeskRow name="2nd Floor" meta="STUDIO ONLY · 8" cap={8} free={[8, 7, 6, 5, 5, 7, 5, 4, 4, 6, 7, 8]} />
            </div>
...
function ScreenAdminItems() {
  const rooms = [["Thought Lounge", "Room · lounge", "6–10", "All tiers · allowance", "Live"], ["Launch Pad", "Room · workshop", "10", "All tiers · allowance", "Live"], ["Future Room", "Room · boardroom", "12", "Studio · 8 hrs/qtr", "Live"], ["Spark Studio", "Room · podcast", "4 / 6", "All tiers · allowance", "Live"]];
  const desks = [["Top Floor desks", "14 hot desks", "1 each", "Atelier+ · top floor", "Live"], ["2nd Floor desks", "8 quiet desks", "1 each", "Studio only", "Live"], ["Phone booths", "3 booths", "1", "Studio+", "Live"]];
        ...
        <div className="wf-row" style={{ gap: 20, alignItems: 'flex-start' }}>
          ...
          <div className="wf-col" style={{ flex: '0 0 320px', gap: 16 }}>
            <div className="wf-card" style={{ padding: 20 }}>
              ...
              <div className="wf-col" style={{ gap: 0 }}>
                {[["Atelier", "Not available", false], ["Studio", "8 hrs / quarter incl.", true]].map(([t, v, on], i) => (
