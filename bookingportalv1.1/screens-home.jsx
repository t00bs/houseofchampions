        ...
        <div className="wf-row" style={{ gap: 22, flex: 1, alignItems: 'stretch' }}>
          ...
          <div className="wf-col" style={{ flex: 1, gap: 18 }}>
            ...
            <div className="wf-col" style={{ gap: 12 }}>
              ...
              <Note kind="Pending sign-off">New section — members buy meeting-room hour bundles as bolt-ons, like add-ons on a phone contract. Package structure &amp; pricing are with Fi for approval; placeholders shown until the signed-off document lands.</Note>
            </div>
          </div>
