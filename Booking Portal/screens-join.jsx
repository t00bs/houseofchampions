...
function ScreenTiers() {
  const tiers = [
    { name: "Atelier", tag: "Flexible access", price: "£225", per: "/ month", cta: "Sign up",
      rows: ["Flexible desk — top floor", "Meeting rooms 4 hrs/mo", "Up to 4 HOC events/mo", "Bike storage · Wi-Fi · coffee"] },
    { name: "Studio", tag: "Desk access · most chosen", price: "£275", per: "/ month", cta: "Sign up",
      rows: ["Priority desk + locker", "Meeting rooms 8 hrs/mo", "Shared membership option", "Honesty-bar credits monthly"] },
    { name: "House", tag: "Full access", price: "£400", per: "/ month", cta: "Sign up",
      rows: ["Unlimited rooms + Future Room", "1 × Spark Studio podcast/yr", "Priority + unlimited events", "Investor / idea exchange"] },
    { name: "Collective", tag: "By invitation", price: "By invitation", per: "", invite: true,
      rows: ["Full-house access", "Terms agreed individually", "Priority everything", "Council introductions"] },
  ];
  return (
    <DesktopShell active={null} hideAvatar>
      <div className="wf-col" style={{ gap: 22, height: '100%' }}>
        ...
        <div className="wf-row" style={{ gap: 14, alignItems: 'center' }}>
          ...
          <Note kind="Collective">Invite-only. Shown but disabled, never hidden — a member can request an introduction from the Council.</Note>
        </div>
      </div>
    </DesktopShell>
  );
    ...
    <SignupShell step={3} title="Confirm your tier." sub="You can change this any time from Plan & membership."
      ...
      <div className="wf-card" style={{ borderColor: 'var(--wf-accent)', borderWidth: 2, padding: 22 }}>
        ...
        <div className="wf-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '12px 28px' }}>
          {[["Desk", "Priority + 2nd-floor locker"], ["Meeting rooms", "8 hrs / month"], ["Events", "Up to 2 / month"], ["Honesty bar", "Food · drink · pour credits"], ["Sharing", "Shareable with one named person"], ["Term", "Monthly rolling"]].map(([k, v], i) =>
