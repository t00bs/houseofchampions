...
const VIEW_SLOTS = ["09:00", "10:30", "12:00", "14:00", "15:30", "17:00"];
      ...
      <section className="apply-wrap">
        <div className="apply-inner">
          <aside className="apply-rail">
            ...
            <p className="rail-note">Viewings run on weekdays. Bring a colleague or a co-founder if it helps, and any questions you've been saving up.</p>
