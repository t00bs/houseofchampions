  ...
  return (
    <>
      ...
      <PageHero
        ...
        lead="Atelier for flexible access, Studio for a desk of your own. A launch offer discounts your first month for the founding cohort."
        meta={[["Tiers", "Two · monthly rolling"], ["From", "£125 / month"], ["Launch", "£100 first month"], ["Day pass", "£35 / day"]]}
        actions={<>
      ...
      <JoinCTA
        ...
        title={<>Join this <em>Spring.</em></>}
        body="A launch offer discounts your first month for the founding cohort. The cohort is capped, when a tier fills, it becomes a considered waitlist from there."
