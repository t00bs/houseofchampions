...
const TIERS = [
  {
    name: "Atelier", tagline: "Flexible access", price: "£125", earlyPrice: "£100", per: "/ month",
  ...
  {
    name: "Studio", tagline: "Desk access", price: "£250", earlyPrice: "£200", per: "/ month",
...
const FAQ = [
  ...
  ["What's the launch offer?", "A founding-cohort discount on your first month for members who join before the doors fully open in Spring 2026. It applies to the first month only; membership then continues at the standard monthly rate."],
