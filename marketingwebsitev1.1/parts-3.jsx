    ...
    <section className="membership reveal" id="membership">
      ...
      <div className="membership-head">
        ...
        <p style={{color:"var(--ink-dim)", maxWidth:"640px", fontSize:"15px", lineHeight:"1.65"}}>
          Atelier for flexible access, Studio for a desk of your own. Early-bird pricing is in place for our founding cohort, lock yours in before the doors fully open.
        </p>
      </div>
      )}
